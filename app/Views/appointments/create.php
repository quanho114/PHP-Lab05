...
<div class="form-header <?= !empty($isDuplicate) ? 'duplicate-header' : '' ?>">
    <h1><?= !empty($isDuplicate) ? 'Create Appointment - Duplicate Appointment Code' : 'Create Appointment' ?></h1>
    <p class="subtitle">Form này submit bằng POST /appointments/store, nếu thành công sẽ redirect về /appointments.</p>
</div>
