...
<div class="form-header <?= !empty($isDuplicate) ? 'duplicate-header' : '' ?>">
    <h1><?= !empty($isDuplicate) ? 'Edit Patient - Duplicate Email' : 'Edit Patient' ?></h1>
    <p class="subtitle">Form này submit bằng POST /patients/update, nếu thành công sẽ redirect về /patients.</p>
</div>
...
<div class="form-container-grid <?= !empty($isDuplicate) ? 'duplicate-grid' : '' ?>">
    <form method="post" action="/patients/update" class="form-card-horizontal">
    ...
    <div class="requirements-card">
        <?php if (!empty($isDuplicate)): ?>
            ...
            <div class="flowchart-container">
                ...
                <div class="flowchart-step">2. Repository UPDATE</div>
                <div class="flowchart-arrow">I</div>
